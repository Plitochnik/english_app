    ...
    <div class=" flex flex-col flex-auto flex-shrink-0 antialiased bg-gray-50 text-gray-800">
        ...
        <div class="fixed flex flex-col top-0 left-0 w-64 bg-white h-full border-r">
            <div class="flex items-center justify-center h-14 border-b">
                <div v-if="userName === 0">
                    <u>
                        <Link :href="route('login')">Войдите в аккаунт</Link>
                    </u>
                </div>
                <div v-else>
            ...
            <span class="inline-flex justify-center items-center ml-4">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                   xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <span
                                class="px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-green-400 bg-green-50 rounded-full">0</span>
                        </a>
                    </li>
                    <li class="px-5">
                        <div class="flex flex-row items-center h-8">
              ...
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                            ...
                            <Link :href="route('profile.show')" class="ml-2 text-sm tracking-wide truncate">Settings
                            </Link>
                        </a>
                    </li>
                    <li>
